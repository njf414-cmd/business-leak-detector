...
export const deepReworkLaborDetector: BusinessLeakDetector = {
  id: "deep.rework-labor",
  name: "Rework Labor",
  description: "Detects rework labor using documented business data and a threshold rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Rework Hours"],
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          ...
          title:
            `${customerName} has a rework labor`,
