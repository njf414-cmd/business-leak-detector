...
export const deepUnprofitableCustomerDetector: BusinessLeakDetector = {
  id: "deep.unprofitable-customer",
  name: "Unprofitable Customer",
  description: "Detects unprofitable customer using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Customer Revenue", "Customer Cost"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.unprofitable-customer",

          leakType:
            "Unprofitable Customer",

          title:
            `${customerName} has a unprofitable customer`,
