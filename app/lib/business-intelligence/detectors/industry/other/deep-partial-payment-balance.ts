...
export const deepPartialPaymentBalanceDetector: BusinessLeakDetector = {
  id: "deep.partial-payment-balance",
  name: "Partial Payment Balance",
  description: "Detects partial payment balance using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Invoice Amount", "Amount Paid"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.partial-payment-balance",

          leakType:
            "Partial Payment Balance",

          title:
            `${customerName} has a partial payment balance`,
