...
export const deepBillableUtilizationGapDetector: BusinessLeakDetector = {
  id: "deep.billable-utilization-gap",
  name: "Billable Utilization Gap",
  description: "Detects billable utilization gap using documented business data and a percentage rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Billable Hours", "Paid Hours"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.billable-utilization-gap",

          leakType:
            "Billable Utilization Gap",

          title:
            `${customerName} has a billable utilization gap`,
          ...
          metadata: {
            ...
            revenueType:
              "billable_utilization_gap",

            detectionReason:
              "deep_billable_utilization_gap",
          },
        });
      }
    );
