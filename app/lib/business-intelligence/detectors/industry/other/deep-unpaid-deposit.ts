...
export const deepUnpaidDepositDetector: BusinessLeakDetector = {
  id: "deep.unpaid-deposit",
  name: "Unpaid Deposit",
  description: "Detects unpaid deposit using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Required Deposit", "Deposit Paid"],
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          ...
          title:
            `${customerName} has a unpaid deposit`,
