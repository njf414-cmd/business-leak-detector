...
export const deepUnbilledLaborHoursDetector: BusinessLeakDetector = {
  id: "deep.unbilled-labor-hours",
  name: "Unbilled Labor Hours",
  description: "Detects unbilled labor hours using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.unbilled-labor-hours",

          leakType:
            "Unbilled Labor Hours",

          title:
            `${customerName} has a unbilled labor hours`,
          ...
          metadata: {
            ...
            revenueType:
              "unbilled_labor_hours",

            detectionReason:
              "deep_unbilled_labor_hours",
          },
        });
      }
    );
