...
export const deepMissedRenewalDetector: BusinessLeakDetector = {
  id: "deep.missed-renewal",
  name: "Missed Renewal",
  description: "Detects missed renewal using documented business data and a age rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Renewal Due Date"],
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          ...
          title:
            `${customerName} has a missed renewal`,
