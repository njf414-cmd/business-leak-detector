...
export const deepTimeRoundedDownDetector: BusinessLeakDetector = {
  id: "deep.time-rounded-down",
  name: "Time Rounded Down",
  description: "Detects time rounded down using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Billed Hours", "Recorded Hours"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.time-rounded-down",

          leakType:
            "Time Rounded Down",

          title:
            `${customerName} has a time rounded down`,
