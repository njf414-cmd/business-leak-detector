...
export const deepUnappliedCustomerCreditDetector: BusinessLeakDetector = {
  id: "deep.unapplied-customer-credit",
  name: "Unapplied Customer Credit",
  description: "Detects unapplied customer credit using documented business data and a threshold rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Unapplied Credit"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.unapplied-customer-credit",

          leakType:
            "Unapplied Customer Credit",

          title:
            `${customerName} has a unapplied customer credit`,
          ...
          metadata: {
            ...
            detectionReason:
              "deep_unapplied_customer_credit",
          },
        });
      }
    );
