...
export const deepOvertimeLeakageDetector: BusinessLeakDetector = {
  id: "deep.overtime-leakage",
  name: "Overtime Leakage",
  description: "Detects overtime leakage using documented business data and a threshold rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Overtime Hours"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.overtime-leakage",

          leakType:
            "Overtime Leakage",

          title:
            `${customerName} has a overtime leakage`,
