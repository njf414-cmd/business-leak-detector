...
export const deepSeverelyAgedReceivableDetector: BusinessLeakDetector = {
  id: "deep.severely-aged-receivable",
  name: "Severely Aged Receivable",
  description: "Detects severely aged receivable using documented business data and a age rule.",
  scope: "universal",
  industries: [],
  requirements: {
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.severely-aged-receivable",

          leakType:
            "Severely Aged Receivable",

          title:
            `${customerName} has a severely aged receivable`,
          ...
          metadata: {
            ...
            revenueType:
              "severely_aged_receivable",

            detectionReason:
              "deep_severely_aged_receivable",
          },
        });
      }
    );
