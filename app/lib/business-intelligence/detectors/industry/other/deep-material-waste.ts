...
export const deepMaterialWasteDetector: BusinessLeakDetector = {
  id: "deep.material-waste",
  name: "Material Waste Above Target",
  description: "Detects material waste above target using documented business data and a percentage rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Wasted Material", "Material Used"],
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          ...
          leakType:
            "Material Waste Above Target",

          title:
            `${customerName} has a material waste above target`,
