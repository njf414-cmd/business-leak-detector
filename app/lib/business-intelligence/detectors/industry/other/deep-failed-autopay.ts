...
export const deepFailedAutopayDetector: BusinessLeakDetector = {
  id: "deep.failed-autopay",
  name: "Failed Autopay",
  description: "Detects failed autopay using documented business data and a threshold rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Failed Autopay Count"],
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          ...
          title:
            `${customerName} has a failed autopay`,
