...
export const deepIdlePaidTimeDetector: BusinessLeakDetector = {
  id: "deep.idle-paid-time",
  name: "Idle Paid Time",
  description: "Detects idle paid time using documented business data and a threshold rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Idle Paid Hours"],
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          ...
          title:
            `${customerName} has a idle paid time`,
