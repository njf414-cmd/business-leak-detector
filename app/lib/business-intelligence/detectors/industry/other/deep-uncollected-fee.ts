...
export const deepUncollectedFeeDetector: BusinessLeakDetector = {
  id: "deep.uncollected-fee",
  name: "Uncollected Fee",
  description: "Detects uncollected fee using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Fee Due", "Fee Collected"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.uncollected-fee",

          leakType:
            "Uncollected Fee",

          title:
            `${customerName} has a uncollected fee`,
