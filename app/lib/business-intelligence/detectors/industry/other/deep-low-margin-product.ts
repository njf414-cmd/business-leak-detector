...
export const deepLowMarginProductDetector: BusinessLeakDetector = {
  id: "deep.low-margin-product",
  name: "Low Margin Product",
  description: "Detects low margin product using documented business data and a percentage rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Gross Profit", "Product Revenue"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.low-margin-product",

          leakType:
            "Low Margin Product",

          title:
            `${customerName} has a low margin product`,
