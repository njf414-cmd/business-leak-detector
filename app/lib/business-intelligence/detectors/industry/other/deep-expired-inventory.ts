...
export const deepExpiredInventoryDetector: BusinessLeakDetector = {
  id: "deep.expired-inventory",
  name: "Expired Inventory",
  description: "Detects expired inventory using documented business data and a age rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Expiration Date"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.expired-inventory",

          leakType:
            "Expired Inventory",

          title:
            `${customerName} has a expired inventory`,
