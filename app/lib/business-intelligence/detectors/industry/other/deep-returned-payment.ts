...
export const deepReturnedPaymentDetector: BusinessLeakDetector = {
  id: "deep.returned-payment",
  name: "Returned Payment",
  description: "Detects returned payment using documented business data and a threshold rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Returned Payment Count"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.returned-payment",

          leakType:
            "Returned Payment",

          title:
            `${customerName} has a returned payment`,
