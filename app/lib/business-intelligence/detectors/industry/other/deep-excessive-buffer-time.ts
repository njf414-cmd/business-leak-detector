...
export const deepExcessiveBufferTimeDetector: BusinessLeakDetector = {
  id: "deep.excessive-buffer-time",
  name: "Excessive Buffer Time",
  description: "Detects excessive buffer time using documented business data and a threshold rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Buffer Minutes"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.excessive-buffer-time",

          leakType:
            "Excessive Buffer Time",

          title:
            `${customerName} has a excessive buffer time`,
          ...
          metadata: {
            ...
            revenueType:
              "excessive_buffer_time",

            detectionReason:
              "deep_excessive_buffer_time",
          },
        });
      }
    );
