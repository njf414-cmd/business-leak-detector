...
export const deepUnderpricedJobDetector: BusinessLeakDetector = {
  id: "deep.underpriced-job",
  name: "Underpriced Job",
  description: "Detects underpriced job using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Selling Price", "Required Price"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.underpriced-job",

          leakType:
            "Underpriced Job",

          title:
            `${customerName} has a underpriced job`,
