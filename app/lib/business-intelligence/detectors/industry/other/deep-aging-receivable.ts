...
export const deepAgingReceivableDetector: BusinessLeakDetector = {
  id: "deep.aging-receivable",
  name: "Aging Receivable",
  description: "Detects aging receivable using documented business data and a age rule.",
  scope: "universal",
  industries: [],
  requirements: {
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.aging-receivable",

          leakType:
            "Aging Receivable",

          title:
            `${customerName} has a aging receivable`,
