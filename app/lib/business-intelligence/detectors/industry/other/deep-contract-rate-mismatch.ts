...
export const deepContractRateMismatchDetector: BusinessLeakDetector = {
  id: "deep.contract-rate-mismatch",
  name: "Contract Rate Mismatch",
  description: "Detects contract rate mismatch using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Charged Rate", "Contract Rate"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.contract-rate-mismatch",

          leakType:
            "Contract Rate Mismatch",

          title:
            `${customerName} has a contract rate mismatch`,
