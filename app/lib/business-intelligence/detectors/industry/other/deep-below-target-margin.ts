...
export const deepBelowTargetMarginDetector: BusinessLeakDetector = {
  id: "deep.below-target-margin",
  name: "Below Target Margin",
  description: "Detects below target margin using documented business data and a percentage rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Gross Profit", "Revenue"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.below-target-margin",

          leakType:
            "Below Target Margin",

          title:
            `${customerName} has a below target margin`,
