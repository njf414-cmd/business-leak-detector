...
export const deepPaymentPlanDelinquencyDetector: BusinessLeakDetector = {
  id: "deep.payment-plan-delinquency",
  name: "Payment Plan Delinquency",
  description: "Detects payment plan delinquency using documented business data and a age rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Payment Due Date"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.payment-plan-delinquency",

          leakType:
            "Payment Plan Delinquency",

          title:
            `${customerName} has a payment plan delinquency`,
          ...
          metadata: {
            ...
            revenueType:
              "payment_plan_delinquency",

            detectionReason:
              "deep_payment_plan_delinquency",
          },
        });
      }
    );
