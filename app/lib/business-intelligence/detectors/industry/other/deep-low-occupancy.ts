...
export const deepLowOccupancyDetector: BusinessLeakDetector = {
  id: "deep.low-occupancy",
  name: "Low Occupancy",
  description: "Detects low occupancy using documented business data and a percentage rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Occupied Units", "Available Units"],
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          ...
          title:
            `${customerName} has a low occupancy`,
