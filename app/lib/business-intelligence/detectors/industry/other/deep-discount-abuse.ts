...
export const deepDiscountAbuseDetector: BusinessLeakDetector = {
  id: "deep.discount-abuse",
  name: "Discount Abuse",
  description: "Detects discount abuse using documented business data and a percentage rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Discount Amount", "Pre-Discount Price"],
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          ...
          title:
            `${customerName} has a discount abuse`,
