...
export const deepDeadStockDetector: BusinessLeakDetector = {
  id: "deep.dead-stock",
  name: "Dead Stock",
  description: "Detects dead stock using documented business data and a age rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Last Sale Date"],
