...
export const deepOpenAppointmentCapacityDetector: BusinessLeakDetector = {
  id: "deep.open-appointment-capacity",
  name: "Open Appointment Capacity",
  description: "Detects open appointment capacity using documented business data and a percentage rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Booked Slots", "Available Slots"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.open-appointment-capacity",

          leakType:
            "Open Appointment Capacity",

          title:
            `${customerName} has a open appointment capacity`,
          ...
          metadata: {
            ...
            revenueType:
              "open_appointment_capacity",

            detectionReason:
              "deep_open_appointment_capacity",
          },
        });
      }
    );
