...
export const deepUnderbookedDayDetector: BusinessLeakDetector = {
  id: "deep.underbooked-day",
  name: "Underbooked Day",
  description: "Detects underbooked day using documented business data and a percentage rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Booked Hours", "Available Hours"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.underbooked-day",

          leakType:
            "Underbooked Day",

          title:
            `${customerName} has a underbooked day`,
