...
export const deepUsageOverageNotBilledDetector: BusinessLeakDetector = {
  id: "deep.usage-overage-not-billed",
  name: "Usage Overage Not Billed",
  description: "Detects usage overage not billed using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Actual Usage", "Billed Usage"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.usage-overage-not-billed",

          leakType:
            "Usage Overage Not Billed",

          title:
            `${customerName} has a usage overage not billed`,
