...
export const deepTechnicianUnderutilizationDetector: BusinessLeakDetector = {
  id: "deep.technician-underutilization",
  name: "Technician Underutilization",
  description: "Detects technician underutilization using documented business data and a percentage rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Billable Hours", "Available Hours"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.technician-underutilization",

          leakType:
            "Technician Underutilization",

          title:
            `${customerName} has a technician underutilization`,
          ...
          metadata: {
            ...
            revenueType:
              "technician_underutilization",

            detectionReason:
              "deep_technician_underutilization",
          },
        });
      }
    );
