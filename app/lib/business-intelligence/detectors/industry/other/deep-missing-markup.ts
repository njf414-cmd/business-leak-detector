...
export const deepMissingMarkupDetector: BusinessLeakDetector = {
  id: "deep.missing-markup",
  name: "Missing Markup",
  description: "Detects missing markup using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Charged Markup", "Required Markup"],
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          ...
          title:
            `${customerName} has a missing markup`,
