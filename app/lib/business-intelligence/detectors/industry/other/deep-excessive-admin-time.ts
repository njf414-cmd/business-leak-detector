...
export const deepExcessiveAdminTimeDetector: BusinessLeakDetector = {
  id: "deep.excessive-admin-time",
  name: "Excessive Admin Time",
  description: "Detects excessive admin time using documented business data and a percentage rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Admin Hours", "Paid Hours"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.excessive-admin-time",

          leakType:
            "Excessive Admin Time",

          title:
            `${customerName} has a excessive admin time`,
          ...
          metadata: {
            ...
            revenueType:
              "excessive_admin_time",

            detectionReason:
              "deep_excessive_admin_time",
          },
        });
      }
    );
