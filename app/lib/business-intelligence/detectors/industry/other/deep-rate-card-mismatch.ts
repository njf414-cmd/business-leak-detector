...
export const deepRateCardMismatchDetector: BusinessLeakDetector = {
  id: "deep.rate-card-mismatch",
  name: "Rate Card Mismatch",
  description: "Detects rate card mismatch using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Charged Rate", "Rate Card Rate"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.rate-card-mismatch",

          leakType:
            "Rate Card Mismatch",

          title:
            `${customerName} has a rate card mismatch`,
