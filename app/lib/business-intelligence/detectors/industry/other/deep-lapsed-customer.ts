...
export const deepLapsedCustomerDetector: BusinessLeakDetector = {
  id: "deep.lapsed-customer",
  name: "Lapsed Customer",
  description: "Detects lapsed customer using documented business data and a age rule.",
  scope: "universal",
  industries: [],
  requirements: {
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.lapsed-customer",

          leakType:
            "Lapsed Customer",

          title:
            `${customerName} has a lapsed customer`,
