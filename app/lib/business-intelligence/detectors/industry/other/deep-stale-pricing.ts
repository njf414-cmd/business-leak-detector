...
export const deepStalePricingDetector: BusinessLeakDetector = {
  id: "deep.stale-pricing",
  name: "Stale Pricing",
  description: "Detects stale pricing using documented business data and a comparison rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Current Cost", "Priced Cost"],
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          ...
          title:
            `${customerName} has a stale pricing`,
