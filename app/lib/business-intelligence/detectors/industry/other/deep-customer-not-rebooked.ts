...
export const deepCustomerNotRebookedDetector: BusinessLeakDetector = {
  id: "deep.customer-not-rebooked",
  name: "Customer Not Rebooked",
  description: "Detects customer not rebooked using documented business data and a age rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Last Service Date"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.customer-not-rebooked",

          leakType:
            "Customer Not Rebooked",

          title:
            `${customerName} has a customer not rebooked`,
          ...
          metadata: {
            ...
            revenueType:
              "customer_not_rebooked",

            detectionReason:
              "deep_customer_not_rebooked",
          },
        });
      }
    );
