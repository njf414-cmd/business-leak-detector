...
export const deepDormantHighValueCustomerDetector: BusinessLeakDetector = {
  id: "deep.dormant-high-value-customer",
  name: "Dormant High-Value Customer",
  description: "Detects dormant high-value customer using documented business data and a age rule.",
  scope: "universal",
  industries: [],
  requirements: {
    requiredFields: ["Revenue Impact", "Last Purchase Date"],
  ...
  async detect(
    ...
    context.rows.forEach(
      (
        ...
        leaks.push({
          detectorId:
            "deep.dormant-high-value-customer",

          leakType:
            "Dormant High-Value Customer",

          title:
            `${customerName} has a dormant high-value customer`,
          ...
          metadata: {
            ...
            detectionReason:
              "deep_dormant_high_value_customer",
          },
        });
      }
    );
